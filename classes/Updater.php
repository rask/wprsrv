...
class Updater
{
    ...
    public function __construct($pluginId, $githubRepoId)
    {
        ...
        $this->pluginFilePath = dirname(__DIR__) . DIRECTORY_SEPARATOR . 'wprsrv.php';
    ...
    {
        wprsrv()->logger->info('Checking plugin updates.');
        ...
        try {
            ...
            wprsrv()->logger->critical('Update issue! {msg}', ['msg' => $e->getMessage()]);
            return $transient;
        }
    ...
    /**
     * Get the currently installed plugin data for wprsrv.
     *
     * @access protected
     * @since 0.1.0
     * @return void
    ...
    protected function getGithubReleaseData()
    {
         ...
         */
        $responseData = apply_filters('wprsrv/update/github_response_data', $responseData);
